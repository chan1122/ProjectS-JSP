            ...
            <div>
                ...
                <div class="wrapp">
                    <div class="ulcoverham">
                        <ul class="hamul">
                            <li>
                                <a href="#" class="abtn" class="hambtnbiga"
                                    >앨범소개</a
                                >
                                <!-- 세부 카테고라 -->
                                <ul class="sham king">
            ...
            <div class="wbx">
                ...
                <section class="Formlogin">
                    ...
                    <form action="process.php" method="post" class="logF">
                        ...
                        <!-- PASSWORD요소 -->
                        <div class="joinPUT">
                            <label for="PWDTEXT" class="JTXT passtxt"
                                >PASSWORD
                            </label>
                            <input
                                class="input_color"
                        ...
                        <!-- PASSWORD 확인 요소 -->
                        <div class="joinPUT">
                            <label for="PWDTEXT2" class="JTXT passtxt"
                                >CHECKPWD
                            </label>
                            <input
                                class="input_color"
                        ...
                        <div class="name joinPUT">
                            <label for="NMJOIN" class="NAME JTXT"> NAME </label>
                            <input
                                type="text"
                                name="JOINNAME"
                                id="JOINNAME"
                        ...
                        <div class="EMAIL joinPUT">
                            <label for="email" class="JTXT EMAIL1">Email</label>
                            <input
                                class="input_color"
                                type="text"
                                id="email1"
                            ...
                            />
                            <span class="ALPA_GOL">@</span>
                            <select name="selmail" id="selmail">
                            ...
                            <span class="Requird-input EINput"></span>
                        </div>
                        <div>
