				...
				<form action="process.php" method="post" class="logF">
					...
					<div class="joinPUT">
						<label for="IDTEXT" class="JTXT IDtxt">ID</label> <input
							...
							maxlength="10" placeholder="ID INSERT HERE" />
						<span class="Requird-input"></span>
					</div>
					<!-- PASSWORD요소 -->
					<div class="joinPUT">
						<label for="PWDTEXT" class="JTXT passtxt">PASSWORD
						</label> <input class="input_color" type="password" name="PWDTEXT"
							id="PWDTEXT" maxlength="20" placeholder="PASSWORD INSERT" />
						<span class="Requird-input"></span>
					</div>
					<!-- PASSWORD 확인 요소 -->
					<div class="joinPUT">
						<label for="PWDTEXT2" class="JTXT passtxt">CHECKPWD
						</label> <input class="input_color" type="password" name="PWDTEXT2"
							id="PWDTEXT2" maxlength="20" placeholder="CHECK PASSWORD" />
						<span class="Requird-input"></span>
					</div>
					<!-- 이름 기입 -->
					...
					<div class="gender joinPUT">
						<label for="gender">GENDER</label> <input class="input_color"
							type="radio" class="WM" /> <input
							class="input_color" type="radio" class="MM" />
						<span class="Requird-input"></span>
					</div>
					<!-- 이메일  -->
