...
<html lang="ko">
  ...
  <head>
    ...
    <body>
        <video
        class="VID"
        src="./images/video/pagevideo.mp4"
        autoplay
        muted
        playninline
        loop
    ...
    <div class="bodywrapp">
      ...
      <main class="per3d">
          ...
          <div class="cbox tm1">
            <div class="mcpop">
              <h2 class="mostpopular">
                M
                <div><span>sot</span></div>
                P
                <div><span>o</span></div>
                P
                <div><span>ular</span></div>
                🔥
              </h2>
            </div>
            <!-- 메인 사진 및 앨범 들어갈 박스 -->
        ...
        <!-- 메인 3페이지(앨범 집약 페이지)
            여기서부터는 똑같은 로직이 반복 되기때문에 줄여서 보시는것을 추천드려요!...!
      ...
      <!-- 하단 플랫 카드
            ...
            (움직이는 요소 SVG밑 로직...이것도 줄여서 보시는것을 추천드려요!)
