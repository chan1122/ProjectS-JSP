	...
	<header>
		...
		<div class="tbox1">
			...
			<ul class="lm">
				...
				<li><a href="#" class="member">Sign</a></li>
			</ul>
			<!-- 로고 싸는 박스 -->
			<div class="top">
			...
			<div class="box nav">
				<nav class="gnb">
					<ul>
						<li class="sm"><a href="#"> 인물소개♡ </a>
							<ul class="ssm">
								<div class="beforebox">
									<li><a href="">페이지 1위곡 인물</a></li>
								</div>
							</ul></li>
						<li class="sm"><a href="#"> CHART♡ </a>
							<ul class="ssm">
								<div class="beforebox">
									...
									<li><a href="">MMJ(일반 음원차트!)</a></li>
								</div>
							</ul></li>
						<li class="sm"><a href="#"> 게시판♡ </a>
							<ul class="ssm">
								<div class="beforebox">
									<li><a href="">회원전용</a></li>
